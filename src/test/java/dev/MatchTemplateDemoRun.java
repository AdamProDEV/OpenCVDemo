...
class MatchTemplateDemoRun implements ChangeListener {
    ...
    private void matchingMethod() {
        ...
        saveImage(img_display, "src/test/resources/images/matcher/1.png");
        Imgproc.rectangle(img_display, matchLoc, new Point(matchLoc.x + templ.cols(), matchLoc.y + templ.rows()),
                new Scalar(0, 0, 0), 2, 8, 0);
        saveImage(img_display, "src/test/resources/images/matcher/2.png");
        saveImage(result, "src/test/resources/images/matcher/3.png");
        Imgproc.rectangle(result, matchLoc, new Point(matchLoc.x + templ.cols(), matchLoc.y + templ.rows()),
                new Scalar(0, 0, 0), 2, 8, 0);
        saveImage(result, "src/test/resources/images/matcher/4.png");
        Image tmpImg = HighGui.toBufferedImage(img_display);
        ImageIcon icon = new ImageIcon(tmpImg);
        imgDisplay.setIcon(icon);
        result.convertTo(result, CvType.CV_8UC1, 255.0);
        saveImage(result, "src/test/resources/images/matcher/5.png");
...
class MatchTemplateDemo {
    ...
    public static void main(String[] args) {
        ...
        // run code
        args = new String[]{"src/test/resources/images/hp.png", "src/test/resources/images/credir.png"};
