...
class OriginalMatcher implements ChangeListener {
...
//        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
        OpenCV.loadShared();
        // run code
//        new OriginalMatcher().run(args);
        new OriginalMatcher().run(new String []{

//                "src/test/resources/images/face.jpg",
                "src/test/resources/images/seleniumMatcher/screenshot.png",
//                "src/test/resources/images/tool.png"
//                "src/test/resources/images/alvaaSmall.png"
                "src/test/resources/images/creditNew.png",
        });
    }
}
